<div class="l-home-contact">
  <div class="p-home-contact--bg">
    <section class="p-home-contact l-container-lg js-fadein">
      <h2 class="p-home-heading"><span class="c-heading--en">Contact</span><span class="c-heading--ja">お問い合わせ</span></h2>
      <p class="p-home-contact__txt">現在お仕事をさせていただける企業様を探しております。<br><span class="c--bold">Webデザインを通して、いい商品やサービスと、人との出会いをつなげていきたい！</span><br><span class="c--bold">勉強熱心な人が多い職場で学び合い<br class="--pc-none">さらにスキルアップをしたい！<br></span>と考えております。<br>興味を持っていただけましたら、ぜひ一度、お話の機会をいただけますと幸いです。</p>

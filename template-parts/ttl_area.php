...
<div class="l-page-ttl p-works-arc-ttl">
  <h1 class="p-works-arc-heading"><?php the_title(); ?></h1>
</div>
<?php } ?>

<?php if(is_singular('works')){ ?>
<div class="l-page-ttl p-works-page-ttl l-container-lg">
  <h1 class="l-page-heading p-works-page-ttl__txt"><span class="c-page-heading--en">Works</span><span class="c-page-heading--ja">制作実績</span></h1>
